...
<body>
  ...
  <main id="app">
      ...
      <div class="container hero-container">
        ...
        <div class="grid grid-2">
          <div>
            ...
            <p class="subhead">
              Choose a base entity, add compatible layers and optional overlays, see total annual cost and
              estimated timelines instantly—within the law. Every plan includes free consulting with a Tax
              Planner.
              <br /><br />
            </p>
          ...
          <div style="display:flex; align-items:center; justify-content:center;">
            <a href="#builder" style="display:inline-block; transition: all 0.3s ease;">
              <img
                src="assets/images/logo-startaway.png"
                alt="Startaway - Build your structure"
    ...
    <section class="section section--trust-band" id="trustband">
      <div class="container">
        <div class="section-id">Section 2: Trust Band</div>
    ...
    <section class="section section--overview" id="overview">
      <div class="container">
        <div class="section-id">Section 3: Overview</div>

        <div class="text-center" style="margin-bottom:32px">
          <div
            class="small"
            style="text-transform:uppercase;letter-spacing:0.1em;font-weight:600;color:var(--secondary)"
          >
        ...
        <div class="text-center" style="margin-top:48px">
          <div
            class="small"
            style="text-transform:uppercase;letter-spacing:0.1em;font-weight:600;color:var(--secondary);margin-bottom:24px"
          >
            What We Offer
          </div>
        </div>
    ...
    <section class="section" id="how-it-works">
      <div class="container">
        <div class="section-id">Section 4: How It Works</div>
    ...
    <section class="section section--orange" id="builder">
      <div class="container">
        <div class="section-id">Section 5: Builder</div>

        <div class="section-header">
          <div class="accent-bar accent-bar--center"></div>
          <h2 class="h2">Structure Builder</h2>
          <p class="p">
            Select your entities and instantly see total annual cost + timelines. Then confirm with a free
    ...
    <section class="section" id="presets">
      <div class="container">
        <div class="section-id">Section 6: Presets</div>
        ...
        <div class="grid grid-3" style="margin-top:24px">
          <div class="card" style="position:relative">
            ...
            <div style="margin-top:12px">
              <button class="btn" data-preset="US-LLC-NM" type="button">Load preset</button>
            </div>
          </div>
          ...
          <div class="card" style="position:relative">
            ...
            <div class="small" style="margin-top:8px">Load this as a starting point.</div>
            <div style="margin-top:12px">
              <button class="btn" data-preset="EE-PLC-OU" type="button">Load preset</button>
            </div>
          </div>
          ...
          <div class="card" style="position:relative">
            ...
            <div class="small" style="margin-top:8px">Load this as a starting point.</div>
            <div style="margin-top:12px">
              <button class="btn" data-preset="UK-LLP-EN" type="button">Load preset</button>
            </div>
          </div>
          ...
          <div class="card" style="position:relative">
            ...
            <div class="small" style="margin-top:8px">Load this as a starting point.</div>
            <div style="margin-top:12px">
              <button class="btn" data-preset="HK-LTD-PT" type="button">Load preset</button>
            </div>
          </div>
          ...
          <div class="card" style="position:relative">
            ...
            <div class="small" style="margin-top:8px">Load this as a starting point.</div>
            <div style="margin-top:12px">
              <button class="btn" data-preset="US-MSB-MT" type="button">Load preset</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <section
      class="section section--navy section--image"
      id="includes"
    ...
    >
      <div class="container">
        ...
        <div class="section-header">
          ...
          <div class="small">
            Scope depends on jurisdiction and activity; your Structure Summary shows exactly what applies.
          </div>
        </div>
    ...
    <section class="section" id="why">
      <div class="container">
        <div class="section-id">Section 8: Why Startaway</div>
        <h2 class="h2 center">Why Startaway?</h2>

        <div class="grid grid-2">
          <div class="card card--reveal" style="animation-delay:0.1s;">
            <div class="card-id">1</div>
            <div class="icon-box">
            ...
            <h3 class="h3">Compliance-first</h3>
            <p>Every structure is built within the law, with ongoing support to keep you compliant.</p>
          </div>

          <div class="card card--reveal" style="animation-delay:0.2s;">
            <div class="card-id">2</div>
            <div class="icon-box">
              <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <h3 class="h3">Multi-jurisdiction expertise</h3>
            <p>US, UK, Estonia, Hong Kong, Canada, Nevis—we handle formations, renewals, and tax prep across borders.</p>
          </div>

          <div class="card card--reveal" style="animation-delay:0.3s;">
            <div class="card-id">3</div>
            <div class="icon-box">
              <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <h3 class="h3">Transparent pricing</h3>
            <p>See your total annual cost upfront—no hidden fees, government charges included.</p>
          </div>

          <div class="card card--reveal" style="animation-delay:0.4s;">
            <div class="card-id">4</div>
            <div class="icon-box">
              <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
            ...
            <h3 class="h3">Expert guidance included</h3>
            <p>Every plan includes free consulting with a Tax Planner to ensure your structure fits your needs.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section section--orange" id="faq">
      <div class="container">
        <div class="section-id">Section 9: FAQ</div>
        ...
        <div class="grid" style="margin-top:48px;max-width:900px;margin-left:auto;margin-right:auto">
          <div class="card card--reveal" style="animation-delay:0.1s;position:relative">
            ...
            <div style="font-weight:800;font-size:18px;margin-bottom:12px;color:var(--primary);padding-left:32px">
              Is this legal?
            </div>
            <div class="small">
              Yes. We support compliant structuring within the law. Fit depends on your facts, jurisdictions, and activity.
            </div>
          </div>
          ...
          <div class="card card--reveal" style="animation-delay:0.2s;position:relative">
            ...
            <div class="small">
              Your Builder shows estimates in business days. We also show two checkpoints: registration readiness and TIN readiness.
            </div>
          </div>
          ...
          <div class="card card--reveal" style="animation-delay:0.3s;position:relative">
            ...
            <div style="font-weight:800;font-size:18px;margin-bottom:12px;color:var(--primary);padding-left:32px">
              Do you file compliance reports?
            </div>
    ...
    <section class="section" id="blog">
      <div class="container">
        <div class="section-id">Section 10: Blog</div>
    ...
    <section class="section" id="about">
      <div class="container">
        <div class="section-id">Section 12: About</div>

        <div style="max-width:800px; margin:0 auto;">
          <h2 class="h2 center">About Startaway</h2>
          <p>
            Startaway helps founders build compliant multi-entity structures across jurisdictions. We combine legal
            expertise, tax planning, and ongoing compliance support to give you a solid foundation for global operations.
          </p>
          <p>
            Our mission is simple: make cross-border structuring transparent, accessible, and compliant—so you can focus
      ...
      <div class="footer__col footer__col--content">
        <div class="footer__section">
          ...
          <p class="footer__legal-text">
            <strong>Startaway Technology LLC</strong> is a technology company with legal and commercial headquarters in
            Albuquerque/NM (United States), administrative base in Warsaw (Poland), and technical management in Helsinki
            (Finland). Regardless of location or language, the terms and conditions of this website are governed by the
            laws of the state of New Mexico, United States of America, and by the laws of the jurisdictions where our
            partners operate. Please consult our Terms of Service before using our services.
          </p>
          <p class="footer__legal-text">
            The "Startaway" brand and the "Flying Away Duck" logo belong to Startaway Technology LLC and are registered
            trademarks in the United States and the European Union. All rights reserved.
          </p>
        </div>
        ...
        <div class="footer__section">
          ...
          <div class="footer__social">
            <a
              href="https://instagram.com/startaway.app"
              target="_blank"
            ...
            <a
              href="https://facebook.com/startaway.app"
              target="_blank"
              rel="noopener noreferrer"
              class="footer__social-link"
              aria-label="Facebook"
            ...
            <a
              href="https://linkedin.com/company/startaway.app"
              target="_blank"
              rel="noopener noreferrer"
              class="footer__social-link"
              aria-label="LinkedIn"
  ...
  <!-- Cloudflare email decode (disabled; you are not using __cf_email__ here) -->
  <!-- <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script> -->

  <!-- Builder (keep ONLY one path; you had two) -->
  <script type="module" src="assets/scripts/builder.js"></script>

  <script>
    (function () {
      // ---------------------------
      // 1) Rolling numbers animation (Trust Band)
      // ---------------------------
      ...
      function initTrustBand() {
        ...
        if (trustBandSection) observer.observe(trustBandSection);
      }

      // ---------------------------
      // 2) Email obfuscation (single copy)
      // ---------------------------
      function initEmail() {
        const user = "hello";
      ...
      let activeTabId = INCLUDES.tabs[0]?.id || "tab-formation";
          ...
          <div class="card">
            <div class="tabs">
              ${INCLUDES.tabs
                .map(
                  (t) => `
                    <button class="tab ${t.id === active.id ? "tab--active" : ""}" data-tab="${esc(t.id)}" type="button">
                      ${esc(t.label)}
                    </button>
                  `
                )
      ...
      // ---------------------------
      // 4) Contact form renderer (mailto fallback)
      // ---------------------------
      function renderContactForm(email) {
      ...
      // ---------------------------
      // 5) Presets: keep stub, but wire buttons without inline onclick
      // ---------------------------
      function wirePresets() {
        document.querySelectorAll("button[data-preset]").forEach((btn) => {
          btn.addEventListener("click", () => {
            // Actual application is handled by builder.js (or later)
